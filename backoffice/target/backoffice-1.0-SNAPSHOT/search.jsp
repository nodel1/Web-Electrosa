    ...
    <body>
        ...
        <main class="main cd-main-content">
            <section>
                ...
                <form action="articles.jsp" method="GET">
                    <fieldset>
                      <legend>¿Qué producto busca?</legend>
                        <div>
                               <label for="cd-search">Buscar en todo el catálogo:</label>
                        <br>
                             <input type="text" name="q" id="cd-search" required>
                          </div>
                        <div>
