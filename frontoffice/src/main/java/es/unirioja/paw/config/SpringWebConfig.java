...
@Bean(name = "simpleMappingExceptionResolver")
    public SimpleMappingExceptionResolver createSimpleMappingExceptionResolver() {
        ...
        mappings.setProperty("es.unirioja.paw.exception.AccessNotAuthorizedException", "error/forbidden");
        mappings.setProperty("es.unirioja.paw.exception.ArticuloNotFoundException", "error/notFound"); // Nuevo mapeo
        mappings.setProperty("es.unirioja.paw.exception.PedidoNotFoundException", "error/notFoundPedido"); // Nuevo mapeo
        ...
        r.addStatusCode("error/notFound", HttpServletResponse.SC_NOT_FOUND); // Nuevo código 404
