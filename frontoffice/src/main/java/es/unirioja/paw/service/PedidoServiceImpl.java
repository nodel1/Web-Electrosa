...
public class PedidoServiceImpl implements PedidoService {
    ...
    public void delete(String codigoPedido) {
        PedidoEntity pedido = findOne(codigoPedido);
        if (pedido != null) {
            logger.info("Eliminando pedido con código: {}", codigoPedido);
            pedidoRepository.delete(pedido);
        } else {
            logger.warn("No se encontró el pedido con código: {} para eliminar", codigoPedido);
        }
    }
